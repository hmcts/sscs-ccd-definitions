...
import task from '../../pages/content/referred.by.admin.judge.task_en.json';
...
export class ReferredByAdminJudgeTask extends BaseStep {
    ...
    async verifyInterlocutoryJudgeCanViewAndCompleteTheAutoAssignedReferredByAdminJudgeTask(caseId: string): Promise<void> {
    ...
    async verifySalariedJudgeCanViewAndCompleteTheUnassignedReferredByAdminJudgeTask(caseId: string): Promise<void> {
    ...
    async verifyFeePaidJudgeCanViewAndCompleteTheUnassignedReferredByAdminJudgeTask(caseId: string): Promise<void> {
    ...
    async verifySalariedJudgeCanViewAndSelfAssignTheReferredByAdminJudgeTask(caseId: string): Promise<void> {
    ...
    async verifyReferredByAdminJudgeTaskIsCancelledAutomaticallyWhenTheCaseIsVoid(caseId: string): Promise<void> {
