...
import {WriteAndIssueAdjourmentNotificationPage} from "../../pages/write.and.issue.adjourment.notification.page";
...
export abstract class BaseStep {
  ...
  protected reviewConfidentialityPage: ReviewConfidentialityPage;
    protected writeAndIssueAdjournmentNotificationPage: WriteAndIssueAdjourmentNotificationPage;
   ...
   constructor(page: Page) {
        ...
        this.writeAndIssueAdjournmentNotificationPage = new WriteAndIssueAdjourmentNotificationPage(this.page);
    }
