...
(0, cucumber_1.When)('I write a final decision generate notice no generate', async function () {
...
(0, cucumber_1.When)('I write a final decision generate notice yes daily living mobility is no face to face', async function () {
    await anyCcdPage.clickElementById('writeFinalDecisionIsDescriptorFlow_No');
    ...
    await anyCcdPage.clickContinue();
    (0, chai_1.expect)(await anyCcdPage.pageHeadingContains('Summary of outcome decision')).to.equal(true);
...
(0, cucumber_1.When)('I write a final decision generate notice yes daily living mobility is yes face to face', async function () {
    ...
    await anyCcdPage.clickContinue();
    (0, chai_1.expect)(await anyCcdPage.pageHeadingContains('Award dates')).to.equal(true);
...
(0, cucumber_1.When)('I see {string}', async function (notice) {
    await anyCcdPage.clickTab('Documents');
    (0, chai_1.expect)(await anyCcdPage.contentContains(notice)).to.equal(true);
});
(0, cucumber_1.When)('I test final decision', async function () {
    const caseReference = '1601983355417609';
    await anyCcdPage.get(`/case/SSCS/Benefit/${caseReference}`);
});
(0, cucumber_1.When)('I issue a final decision generate decision no', async function () {
    await anyCcdPage.clickSubmit();
    // await anyCcdPage.clickSubmit();
    (0, chai_1.expect)(await anyCcdPage.contentContains('Decision in favour of appellant')).to.equal(true);
});
(0, cucumber_1.When)('I issue a final decision generate decision upheld', async function () {
    await anyCcdPage.clickSubmit();
    (0, chai_1.expect)(await anyCcdPage.contentContains('Decision upheld')).to.equal(true);
});
//# sourceMappingURL=issue-decision.steps.js.map