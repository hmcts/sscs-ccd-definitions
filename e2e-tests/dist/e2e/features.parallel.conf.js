...
const logger = nodejs_logging_1.Logger.getLogger('features.parallel.conf');
...
const maxInstances = Math.max(config_1.default.get('protractor.RunWithNumberOfBrowsers'), 2);
...
const reportDir = path_1.default.resolve(testOutputDir, 'functional');
...
//# sourceMappingURL=features.parallel.conf.js.map