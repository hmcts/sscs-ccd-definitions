 ...
 * @group Errors
 */
export declare class ErrorSerialiser {
    private static readonly recognisedErrors;
    ...
    private static isSerialisable;
    private static isDeserialisable;
    static deserialiseFromStackTrace(stack: string): Error;
}
//# sourceMappingURL=ErrorSerialiser.d.ts.map